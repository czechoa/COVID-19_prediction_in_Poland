from prepareData.make_train_test_from_merge_data import *
...
from prepareData.data_augmentation import data_augmentation_without_Poland_as_sum
...
make_prediction_and_subplot_for_all_regions(subplot= False)
# %%
